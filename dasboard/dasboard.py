...
@st.cache_data
def load_data():
    df_day = pd.read_csv("https://github.com/LLEENX/DataAnalyst-Bike-Sharing/blob/main/dasboard/cleaned_days_df.csv")  # Dataset untuk data harian
    df_hour = pd.read_csv("https://github.com/LLEENX/DataAnalyst-Bike-Sharing/blob/main/dasboard/cleaned_hours_df.csv")  # Dataset untuk data jam
